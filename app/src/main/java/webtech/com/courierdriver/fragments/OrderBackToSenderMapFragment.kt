...
class OrderBackToSenderMapFragment : Fragment() {
    ...
    private lateinit var binding: FragmentOrderBackToSenderMapBinding
...
//        }
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_order_back_to_sender_map, container, false)
        return view
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentOrderBackToSenderMapBinding.bind(view)
        ...
        LogUtils.error(
            LogUtils.TAG,
            " orderEntity!!.senderName in OrderBackToSenderMapFragment => " + orderEntity!!.senderName
        );
        ...
        if (orderEntity!!.typeOfOrder!!.equals(OGoConstant.RETURN_TRIP_COMP_TO_CLIENT) || orderEntity!!.typeOfOrder!!.equals(
        ...
        binding.backToSenderName!!.setText(orderEntity!!.senderName!!)
        ...
        binding.tvPhoneNumberBackToSender!!.setText(orderEntity!!.senderPhone!!)

        val startAnimation = AnimationUtils.loadAnimation(context, R.anim.blinking_animation_once)
        binding.ivCallBackToSender!!.startAnimation(startAnimation)
...
//        editDeliveryCharges!!.setText( String.format("%.3f", orderEntity!!.totalFare!!.toDouble()) + " KD")
        ...
        if (orderEntity!!.source!!.equals(OGoConstant.WEB, true)) {
            ...
            binding.editTotalInvoiceOrder!!.setText(
                String.format(
                    "%.3f",
                    orderEntity!!.totalInvoiceAmount!!.toDouble()
                ) + " KD"
            )
            ...
            if (orderEntity!!.gatewayType!!.equals(OGoConstant.COD, true)) {
                ...
                binding.orderPaymentNote!!.setText(
                    getString(R.string.back_to_order_payment_msg) + "(" + String.format(
                        "%.3f",
                        orderEntity!!.totalInvoiceAmount!!.toDouble()
                    ) + " KD" + ")"
                )
            ...
            if (orderEntity!!.gatewayType!!.equals(OGoConstant.COD, true)) {
                ...
                binding.orderPaymentNote!!.setText(
                    getString(R.string.back_to_order_payment_msg) + "(" + String.format(
                        "%.3f",
                        orderEntity!!.totalFare!!.toDouble()
                    ) + " KD" + ")"
                )
        ...
        binding.backToSenderPhoneLayout.setOnClickListener {
        ...
        binding.tvDirectionBackToSenderLayout.setOnClickListener {

            val intent = Intent(
                android.content.Intent.ACTION_VIEW,
                Uri.parse("https://maps.google.com/maps?daddr=$senderLat,$senderLon")
            )
            startActivity(intent)

        }

        binding.transparentOverlayBackToSenderDetails.setOnClickListener {
        ...
        binding.arrivedBackToSenderSlideView!!.setOnSlideCompleteListener {
            // vibrate the device
            ...
            val startAnimation =
                AnimationUtils.loadAnimation(mActivity, R.anim.blinking_animation_once)
            binding.returnOrderDeliveredSlideView.startAnimation(startAnimation)
            ...
            if (NetworkUtil.getInstance(mActivity!!).isOnline) {
                ...
                updateOrderStatusPost(
                    ...
                    orderEntity!!.orderId!!,
                    preferenceHelper!!.loggedInUser!!.cid!!,
                    OGoConstant.RETURN_ORDER_TO_SOURCE
                )
        ...
        binding.returnOrderDeliveredSlideView!!.setOnSlideCompleteListener {
            ...
            titleMsg = getString(R.string.order_return_deliver_title)
            message = getString(R.string.order_return_deliver_messege)
            positiveButtonMsg = getString(R.string.order_collection_no)
            negativeButtonMsg = getString(R.string.order_return_deliver_yes)
                ...
                .setNegativeButton(negativeButtonMsg, OnClickListener() {
                    ...
                    if (NetworkUtil.getInstance(mActivity!!).isOnline) {
                        ...
                        updateOrderStatusPost(
                            ...
                            orderEntity!!.orderId!!,
                            preferenceHelper!!.loggedInUser!!.cid!!,
                            OGoConstant.RETURN_ORDER_DELIVERED
                        )

                        run {
                            val mPlayer =
                                MediaPlayer.create(mActivity, R.raw.door_entry_notification)
                            mPlayer.start()

                            LogUtils.error(
                                LogUtils.TAG,
                                "Status => mPlayer.start(); called : order collection confirmed!"
                            )
                        }
...
//        mapFragment.getMapAsync(mapAsync)
        ...
        //Log.e("Test"," myLat in onCreateView() OrderBackToSenderMapFragment.java =>  "+ myLat );
        //Log.e("Test"," myLon in onCreateView() OrderBackToSenderMapFragment.java =>  "+ myLon );
...
//    }
    ...
    override fun onResume() {
        ...
        (mActivity as AppCompatActivity).getSupportActionBar()!!
            .setTitle(R.string.back_to_sender_title)
    ...
    fun onLocationUpdated(event: LocationChangedEvent) {
        ...
        // Log.e("Test"," myLat in onLocationUpdated() OrderBackToSenderMapFragment.java =>  "+ myLat );
        // Log.e("Test"," myLon in onLocationUpdated() OrderBackToSenderMapFragment.java =>  "+ myLon );
    }
    ...
    companion object {
        ...
        fun newInstance(orderEntityJsonString: String): OrderBackToSenderMapFragment {

            val fragment = OrderBackToSenderMapFragment()
            val args = Bundle()
    ...
    fun updateOrderStatusPost(
        ...
        apiPostService!!.postUpdateOrderStatus(userNameStr, orderId, companyId, orderStatus)
            .enqueue(object : Callback<UpdateOderStatusResp> {

                override fun onResponse(
                    call: Call<UpdateOderStatusResp>,
                    response: Response<UpdateOderStatusResp>
                ) {
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (responseBodyRecived!!.status.toString().equals("true", true)) {
                            LogUtils.error(
                                LogUtils.TAG,
                                "postUpdateOrderStatus responseBodyRecived!!.message.toString() =>" + responseBodyRecived!!.message.toString()
                            )
                            LogUtils.error(
                                LogUtils.TAG,
                                "responseBodyRecived!!.data!! =>" + responseBodyRecived!!.data!!
                            )
                            //Toast.makeText(mActivity, responseBodyRecived!!.message, Toast.LENGTH_LONG).show()

                            if (responseBodyRecived!!.data!!.equals(OGoConstant.RETURN_ORDER_TO_SOURCE_STRING)) {

                                binding.returnOrderDeliveredSlideView!!.visibility = View.VISIBLE
                                binding.arrivedBackToSenderSlideView!!.visibility = View.GONE
                                binding.tvFinishLayout!!.visibility = View.GONE

                                preferenceHelper!!.orderStatus = OGoConstant.RETURN_ORDER_TO_SOURCE
                            ...
                            } else if (responseBodyRecived!!.data!!.equals(OGoConstant.RETURN_ORDER_DELIVERED_STRING)) {

                                preferenceHelper!!.orderStatus = OGoConstant.RETURN_ORDER_DELIVERED
                                UpdateRealTimeDriverOrderStatus.updateRealTimeDriverOrderStatus(
                                    mActivity!!,
                                    OGoConstant.RETURN_ORDER_DELIVERED
                                )
                            ...
                            } else if (responseBodyRecived.data!!.equals(OGoConstant.RETURN_ORDER_COMPLETED_STRING)) {
                                Toast.makeText(
                                    mActivity,
                                ...
                                preferenceHelper!!.orderStatus = OGoConstant.RETURN_ORDER_COMPLETED
                                UpdateRealTimeDriverOrderStatus.updateRealTimeDriverOrderStatus(
                                    mActivity!!,
                                    OGoConstant.RETURN_ORDER_COMPLETED
                                )
                ...
                override fun onFailure(call: Call<UpdateOderStatusResp>, t: Throwable) {
                    ...
                    if (t is IOException) {
                        ...
                        Toast.makeText(
                            mActivity,
                            " Unable to submit postUpdateOrderStatus to API.!",
                            Toast.LENGTH_LONG
                        ).show();
                    }
                    ...
                    LogUtils.error(
                        "TAG",
                        "Unable to submit postUpdateOrderStatus to API." + t.printStackTrace()
                    )
    ...
    fun returnOrderCollectedCase() {
        binding.arrivedBackToSenderSlideView!!.visibility = View.VISIBLE
        binding.returnOrderDeliveredSlideView!!.visibility = View.GONE
        binding.tvFinishLayout!!.visibility = View.GONE
    }


    fun driverAtBackToSourceCase() {
        binding.arrivedBackToSenderSlideView!!.visibility = View.GONE
        binding.returnOrderDeliveredSlideView!!.visibility = View.VISIBLE
        binding.tvFinishLayout!!.visibility = View.GONE
